...
import { MouseParallax } from "react-just-parallax"; //Easily add dynamic scrolling animations to elements, making background elements move more slowly than foreground elements as the user scrolls.
